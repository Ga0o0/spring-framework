 ...
 * @since 16.04.2003
 */
// URL 映射 {@link HandlerMapping} 实现的抽象基类。
//
// <p>支持文字匹配和模式匹配，例如“/test/”、“/test/”等。有关模式语法的详细信息，
// 请参阅 {@link PathPattern}（如果已解析模式已启用 {@link #usesPathPatterns()}），
// 否则请参阅 {@link AntPathMatcher}。语法大致相同，但 {@code PathPattern} 语法更适合 Web 应用程序，并且其实现效率更高。
//
